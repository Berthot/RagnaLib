...
namespace RagnaLib.Wrapper.Wrappers;

public class WrapperService
{
    private readonly WrapperFactory _factory = new WrapperFactory();
    private readonly IReadData _readCsv = new ReadCsv();
    private readonly WrapperRepository _repo = new WrapperRepository(new Context());
